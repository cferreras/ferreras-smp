...
const formatMessage = ({ title, description }, slug) => {
  ...
  const prefix = `[${safeTitle}](https://cubusfera.com/blog/${slug})\n\n`;
...
const selfTest = () => {
  ...
  assert.deepEqual(announcements(files, cwd), [{ file: "src/content/blog/new.md", message: "[Nuevo \\[blog\\]](https://cubusfera.com/blog/new)\n\nMensaje breve." }]);
